...
\hypersetup{
    ...
    linkcolor=CVPrimary,
    urlcolor=CVPrimary,
    pdftitle={Samir N. Ruza - Profesional en Gestión y Administración},
    pdfauthor={Samir N. Ruza},
    pdfsubject={Curriculum Vitae - Samir N. Ruza},
    pdfkeywords={Curriculum Vitae, Samir Ruza, Gestión, Administración, Organización, Liderazgo, Trabajo en Equipo, Resolución de Problemas, Coordinación de Proyectos}
}
...
\newcommand{\CVHeader}{
    ...
    {\large\color{CVText}\ttfamily Consultor Tecnológico y Gestión de Proyectos}
    &
    \footnotesize
    ...
    \CVContact{ubi.}{Maturín, Edo. Monagas}
    \end{minipage}
    \end{tabular}}
}
...
\CVTextBlock{Profesional en gestión operativa con experiencia en la ejecución de proyectos, optimización de procesos y atención a usuarios. Busco colaborar y aportar organización, trabajo en equipo, resolución de problemas y mejora continua en roles comerciales, administrativos e institucionales.}
...
% --- Entrada 1 ---
\CVExpMeta{Gestor de Proyectos Digitales}
{Independiente}
{Trabajo Remoto}
{OCT 2024 - ENE 2026}
\switchcolumn
\CVExpBody{
Gestión integral del ciclo de servicio, desde la consulta inicial hasta la entrega y el soporte posterior, para clientes independientes.
\begin{itemize}[label=\textcolor{CVBullet}{–}, leftmargin=0.5cm, topsep=0.4cm, itemsep=0.15cm]
    \item Asesoría y seguimiento continuo en cada etapa del proceso de servicio.
    \item Gestión de pedidos, inventario y logística de entregas para garantizar el cumplimiento en tiempo y forma.
    \item Levantamiento de requerimientos, negociación de condiciones y resolución de incidencias para asegurar la satisfacción de los usuarios.
    \item Coordinación del ciclo completo de servicio: cotización, ejecución, entrega y soporte posterior.
\end{itemize}
}
\switchcolumn*
...
\begin{itemize}[label=\textcolor{CVBullet}{–}, leftmargin=0.5cm, topsep=0.4cm, itemsep=0.15cm]
    \item Organización y coordinación de eventos institucionales, articulando múltiples áreas y garantizando el cumplimiento de agendas.
    \item Gestión, clasificación y resguardo de información confidencial de usuarios y departamentos.
    \item Atención a usuarios y departamentos internos, canalizando requerimientos y agilizando trámites administrativos.
    \item Elaboración de propuestas de mejora de flujos de trabajo para optimizar procesos operativos institucionales.
\end{itemize}
}
\switchcolumn*

% --- Entrada 3 ---
\CVExpMeta{Gestor de Proyectos}
{Independiente}
{Trabajo Remoto}
{ENE 2022 - JUL 2023}
\switchcolumn
\CVExpBody{
Prestación de servicios integrales de asesoría y gestión a usuarios y organizaciones.
\begin{itemize}[label=\textcolor{CVBullet}{–}, leftmargin=0.5cm, topsep=0.4cm, itemsep=0.15cm]
    \item Planificación de entregas y cumplimiento de plazos, optimizando el tiempo operativo de cada proyecto.
    \item Comunicación continua para alinear expectativas y coordinar cada etapa del servicio.
    \item Resolución de requerimientos y seguimiento de solicitudes hasta su cierre, garantizando atención oportuna.
    \item Gestión de pedidos, logística y control de inventario.
\end{itemize}
}
...
{\DMSansLight
\begin{multicols}{2}
    \textcolor{CVBullet}{–} Orientación al servicio \\
    \textcolor{CVBullet}{–} Resolución de problemas \\
    \textcolor{CVBullet}{–} Organización y planificación \\
    \textcolor{CVBullet}{–} Comunicación efectiva \\
    \textcolor{CVBullet}{–} Liderazgo \\
    \textcolor{CVBullet}{–} Gestión del tiempo \\
    \textcolor{CVBullet}{–} Negociación \\
    \textcolor{CVBullet}{–} Trabajo en equipo \\
    \textcolor{CVBullet}{–} Manejo de ofimática (Word, Excel)
\end{multicols}
}

% --- IDIOMAS ---
\CVSectionNormal{Idiomas}
{\DMSansLight
\begin{multicols}{2}
    \textcolor{CVBullet}{–} Español: Nativo \\
    \textcolor{CVBullet}{–} Inglés: Comprensión lectora intermedia
\end{multicols}
}

% --- INTERESES EXTRACURRICULARES ---
\CVSectionNormal{Intereses}
{\DMSansLight
\textcolor{CVBullet}{–} E-commerce \\
\textcolor{CVBullet}{–} Publicidad y mercadeo \\
\textcolor{CVBullet}{–} Innovación tecnológica \\
