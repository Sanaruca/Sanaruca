...
\hypersetup{
    ...
    linkcolor=CVPrimary,
    urlcolor=CVPrimary,
    pdftitle={Samir N. Ruza - Analista de Sistemas},
    pdfauthor={Samir N. Ruza},
    pdfsubject={Curriculum Vitae - Samir N. Ruza - PDVSA AIT},
    pdfkeywords={Curriculum Vitae, Samir Ruza, Analista de Sistemas, PDVSA, AIT, Automatizacion, Informatica, Telecomunicaciones, Desarrollo de Software, Bases de Datos, SQL, Node.js, Sistemas de Informacion, Transformacion Digital}
}
...
\newcommand{\CVHeader}{
    ...
    {\large\color{CVText}\ttfamily Analista de Sistemas}
    &
    \footnotesize
...
\CVTextBlock{Analista de sistemas con experiencia en el desarrollo e implementación de soluciones tecnológicas para la gestión administrativa y operativa. Especializado en bases de datos, desarrollo de APIs y automatización de procesos en entornos institucionales. Comprometido con la eficiencia operacional, la confiabilidad de los sistemas y el aprovechamiento óptimo de los recursos tecnológicos disponibles. Enfoque orientado a resultados medibles, trabajo en equipo multidisciplinario y mejora continua.}
...
% --- Entrada 1 ---
\CVExpMeta{Desarrollador de Sistemas}
{Independiente}
{Trabajo Remoto}
{OCT 2024 - ENE 2026}
\switchcolumn
\CVExpBody{
Diseño, desarrollo e implementación de soluciones de software a medida para clientes independientes.
\begin{itemize}[label=\textcolor{CVBullet}{–}, leftmargin=0.5cm, topsep=0.4cm, itemsep=0.15cm]
    \item Desarrollo de APIs RESTful para la integración de sistemas de gestión de pedidos y control de inventario.
    \item Implementación de métodos de pago seguros y sistema de autenticación (OAuth2) en plataformas digitales.
    \item Desarrollo de aplicación móvil con funcionalidades de comunicación en tiempo real (llamadas de voz y video).
\end{itemize}
}
\switchcolumn*

% --- Entrada 2 ---
\CVExpMeta{Analista de Sistemas}
{DCTI / Gobernación del Estado Monagas}
{Maturín, Edo. Monagas}
{SEP 2023 - OCT 2024}
\switchcolumn
\CVExpBody{
Entidad pública dedicada a impulsar la modernización y eficiencia administrativa mediante soluciones tecnológicas.
\begin{itemize}[label=\textcolor{CVBullet}{–}, leftmargin=0.5cm, topsep=0.4cm, itemsep=0.15cm]
    \item Desarrollo de sistema integral para la organización, seguimiento y control de eventos institucionales.
    \item Diseño e implementación de API para la propuesta de un nuevo sistema de Plan Operativo Anual (POA).
    \item Creación de módulos de usuario con accesos seguros, personalizados y controlados por roles.
    \item Gestión, clasificación y resguardo de información confidencial de usuarios y departamentos.
    \item Elaboración de propuestas de mejora de flujos de trabajo para optimizar procesos operativos.
\end{itemize}
}
\switchcolumn*

% --- Entrada 3 ---
\CVExpMeta{Desarrollador de Software}
{Independiente}
{Trabajo Remoto}
{ENE 2022 - JUL 2023}
\switchcolumn
\CVExpBody{
Desarrollo de soluciones tecnológicas personalizadas, enfocado en servicios integrales de desarrollo web y automatización.
\begin{itemize}[label=\textcolor{CVBullet}{–}, leftmargin=0.5cm, topsep=0.4cm, itemsep=0.15cm]
    \item Diseño e implementación de interfaces web funcionales y responsivas con HTML, CSS y JavaScript.
    \item Creación de scripts para automatizar tareas repetitivas de administración y mantenimiento en servidores.
    \item Implementación de sistema seguro de inicio de sesión y acceso autorizado (OAuth2).
    \item Desarrollo de API robusta y escalable para la gestión de pedidos en plataformas de comercio electrónico.
\end{itemize}
}
...
\CVSectionNormal{Habilidades Técnicas}
{\DMSansLight
\begin{multicols}{2}
    \textcolor{CVBullet}{–} SQL / Bases de Datos \\
    ...
    \textcolor{CVBullet}{–} Python
\end{multicols}
}

% --- HABILIDADES BLANDAS ---
\CVSectionNormal{Habilidades Organizacionales}
{\DMSansLight
\begin{multicols}{2}
    \textcolor{CVBullet}{–} Análisis y resolución de problemas \\
    \textcolor{CVBullet}{–} Gestión de proyectos \\
    \textcolor{CVBullet}{–} Trabajo en equipo \\
    \textcolor{CVBullet}{–} Comunicación efectiva \\
    \textcolor{CVBullet}{–} Organización y planificación \\
    \textcolor{CVBullet}{–} Gestión del tiempo \\
    \textcolor{CVBullet}{–} Adaptabilidad \\
    \textcolor{CVBullet}{–} Orientación a resultados
\end{multicols}
}

% --- INTERESES EXTRACURRICULARES ---
\CVSectionNormal{Intereses Profesionales}
{\DMSansLight
Automatización de procesos y sistemas \textcolor{CVLine}{|} Transformación digital \textcolor{CVLine}{|} Seguridad informática \textcolor{CVLine}{|} Internet de las Cosas (IoT) \textcolor{CVLine}{|} Inteligencia artificial aplicada
}
